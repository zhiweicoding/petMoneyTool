...
<head>
    ...
    <link rel="stylesheet"
          href="https://lg-qrm18qcm-1255940368.cos.ap-shanghai.myqcloud.com/20200607/jquery-weui.min.css">
    ...
    <section class="aui-scrollView">
        ...
        <div class="stepBody">
            ...
            <div class="weui-cells weui-cells_form">
                <div class="weui-cell">
                    <div class="weui-cell__bd">
                        <textarea class="weui-textarea" id="tall" placeholder="请输入您的遇到的问题" rows="3"></textarea>
                    ...
                    <div class="weui-cell__bd">
                        <div class="weui-uploader">
                            <div class="weui-uploader__hd">
                                <p class="weui-uploader__title">补充证明材料1</p>
                            </div>
            ...
            <div class="weui-cells weui-cells_form">
                <div class="weui-cell">
                    <div class="weui-cell__bd">
                        <div class="weui-uploader">
                            <div class="weui-uploader__hd">
                                <p class="weui-uploader__title">补充证明材料2</p>
                            </div>
                            <div class="weui-uploader__bd">
            ...
            <div class="weui-cells weui-cells_form">
                <div class="weui-cell">
                    <div class="weui-cell__bd">
                        <div class="weui-uploader">
                            <div class="weui-uploader__hd">
                                <p class="weui-uploader__title">补充证明材料3</p>
                            </div>
                            <div class="weui-uploader__bd">
            ...
            <div class="weui-cells weui-cells_form">
                <div class="weui-cell">
                    <div class="weui-cell__bd">
                        <div class="weui-uploader">
                            <div class="weui-uploader__hd">
                                <p class="weui-uploader__title">补充证明视频</p>
                            </div>
                            <div class="weui-uploader__bd">
            ...
            <div class="weui-msg">
                ...
                <div class="weui-msg__opr-area">
                    <p class="weui-btn-area">
                        ...
                        <a href="javascript:sendNotice('${serviceId}','申请平台人工介入',1);"
                           class="weui-btn fontcss ">申请平台人工介入</a>
                    </p>
                </div>
            </div>
        </div>
