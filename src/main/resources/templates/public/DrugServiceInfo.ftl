    ...
    <section class="aui-scrollView">
        ...
        <div class="stepBody">
            ...
            <div class="weui-cells weui-cells_form">
                <div class="weui-cell">
                    <div class="weui-cell__bd">
                        <textarea class="weui-textarea" id="tall" placeholder="请输入接到猫咪时间和情况描述" rows="3"></textarea>
                    ...
                    <div class="weui-cell__bd">
                        <div class="weui-uploader">
                            <div class="weui-uploader__hd">
                                <p class="weui-uploader__title">猫咪猫癣正面照</p>
                            </div>
            ...
            <div class="weui-cells weui-cells_form">
                <div class="weui-cell">
                    <div class="weui-cell__bd">
                        <div class="weui-uploader">
                            <div class="weui-uploader__hd">
                                <p class="weui-uploader__title">猫咪猫癣补充照片</p>
                            </div>
                            <div class="weui-uploader__bd">
