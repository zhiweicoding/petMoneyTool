...
<head>
    ...
    <link rel="stylesheet" href="${base}/resources/mobileCss/discounts.css">
...
<header class="aui-header-default aui-header-fixed " style="height: 52px;">
    ...
    <div class="aui-header-center aui-header-center-clear">
        <div class="aui-header-center-logo" style="width:auto;">
            <div class="" style="width:auto;">优惠券</div>
        </div>
    </div>
...
<div class="aui-content-box" style="margin-top: 55px;height:100%;padding-bottom: 0;margin-bottom: 0;">
    <div class="container">
        <div class="discounts-form">
            <div class="input-box">
                <input class="discounts-sn" placeholder="请输入优惠码" />
        ...
        <div class="empty-view">
            <img class="icon" src="https://lg-qrm18qcm-1255940368.cos.ap-shanghai.myqcloud.com/temp-upload/nocoupon.png" style='margin-top:15px;width:70px;height:70px;'>
            <span class="text">还没有添加优惠券</span>
        </div>
