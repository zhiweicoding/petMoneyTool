...
<head>
    ...
    <link rel="stylesheet" href="${base}/resources/mobileCss/protectList.css">
...
<div class="aui-content-box" style="margin-top: 55px;">
    <div>
        <a class="item aui-flex b-line" href='${base}/help/cat'>
            <div class="item-main aui-flex-box">
                <div class="title">《优宠熊猫咪 购买 消费者保障协议》</div>
                <div class="info" style="margin-top: 3px;margin-left: 3px;">
                    <div class="times">2018-2-10 10:20:0</div>
                </div>
            </div>
            <div class='clickS'></div>
        </a>
        <a class="item aui-flex b-line" href='${base}/help/cathalf'>
            <div class="item-main aui-flex-box">
                <div class="title">《优宠熊猫咪 半价 消费者保障协议》</div>
                <div class="info" style="margin-top: 3px;margin-left: 3px;">
                    <div class="times">2018-9-10 10:20:0</div>
                </div>
            </div>
            <div class='clickS'></div>
        </a>
