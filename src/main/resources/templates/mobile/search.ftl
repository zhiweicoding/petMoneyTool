...
<head>
    ...
    <link rel="stylesheet" href="${base}/resources/mobileCss/search.css">
...
<header class="aui-header-default aui-header-fixed " style="height: 52px;">
    ...
    <div class="aui-header-center aui-header-center-clear">
        <div class="aui-header-center-logo" style="width:auto;">
            <div class="" style="width:auto;">保障协议列表</div>
        </div>
    </div>
...
<div class="aui-content-box" style="margin-top: 55px;">
    <div class="search-header">
        <div class="input-box">
            <img class="icon" src="https://photo.youchongxiong.com/search2-2fb94833aa.png">
            <input name="input" class="keywrod" focus="true" value="${result.defaultKeyword.keyword}"
                   confirm-type="search" bindinput="inputChange"
                   bindfocus="inputFocus" bindconfirm="onKeywordConfirm" confirm-type="search"
                   placeholder="请输入品种名称"/>
            <img class="del" onclick="clearKeyword()"
                 src="https://photo.youchongxiong.com/clearIpt-f71b83e3c2.png">
        </div>
        <div class="right" onclick="closeSearch()">取消</div>
    </div>
    <div class="no-search">
        <div class="serach-keywords search-hot">
            <div class="h">
                <span class="title">热门搜索</span>
            </div>
            <div class="b">
                <#list result.hotKeywords as hotKeywords>
                    <#if hotKeywords.is_hot==1>
                        <div onclick="openUrl('${base}/webMobile/type/cat?symbolId=${hotKeywords.keywordId}')"
                             class="item active" hover-class="navigator-hover">
                            ${hotKeywords.keyword}
                        </div>
                    <#else >
                        <div onclick="openUrl('${base}/webMobile/type/cat?symbolId=${hotKeywords.keywordId}')"
                             class="item " hover-class="navigator-hover">
                            ${hotKeywords.keyword}
                        </div>
                    </#if>
