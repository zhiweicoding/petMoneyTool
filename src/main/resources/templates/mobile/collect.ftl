...
<head>
    ...
    <link rel="stylesheet" href="${base}/resources/mobileCss/collect.css">
...
<header class="aui-header-default aui-header-fixed " style="height: 52px;">
    ...
    <div class="aui-header-center aui-header-center-clear">
        <div class="aui-header-center-logo" style="width:auto;">
            <div class="" style="width:auto;">我的喜欢</div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="collect-list">
            <#list arrays as arrays>
                <div class="item" onclick="openUrl('${base}/webMobile/good/index/${arrays.goodId}')">
                    <img class="img" src="${arrays.listPicUrl}">
                    <div class="info">
                        <div class="name">${arrays.goodTitle}</div>
                        <div class="subtitle">${arrays.goodBrief}</div>
                        <div class="price">￥${arrays.retailPrice}</div>
                    </div>
                    <div class="r">
                        <img alt="删除我的喜欢"
                             catchtap="deleteCollect" class="del"
                             src="https://lg-qrm18qcm-1255940368.cos.ap-shanghai.myqcloud.com/temp-upload/del-address.png"
                             onclick="delGood('${arrays.goodId}')">
                    </div>
                </div>
            </#list>

        </div>
        <#--<div class="search-result-empty" wx:if="{{collectList.length<=0}}">-->
        <#--<img class="icon" src="https://lg-qrm18qcm-1255940368.cos.ap-shanghai.myqcloud.com/noSearchResult-7572a94f32.png">-->
        <#--<span class="text">您还没有添加过喜欢的优宠</span>-->
        <#--</div>-->
    </div>
</div>
...
<script>
    ...
    function delGood(goodId) {
        $.post('${base}/webMobile/mobileMine/delete', {
            goodId: goodId
        }, function (data) {
