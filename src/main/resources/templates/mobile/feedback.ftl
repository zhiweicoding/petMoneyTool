...
<head>
    ...
    <link rel="stylesheet" href="${base}/resources/mobileCss/feedback.css">
...
<header class="aui-header-default aui-header-fixed " style="height: 52px;">
    ...
    <div class="aui-header-center aui-header-center-clear">
        <div class="aui-header-center-logo" style="width:auto;">
            <div class="" style="width:auto;">意见反馈</div>
        </div>
    </div>
...
<div class="aui-content-box" style="margin-top: 55px;">
    <div class="container">
        ...
        <div class="fb-body">
            <textarea class="content" placeholder="对我们网站、宠物、服务，你还有什么建议吗？你还希望在优宠熊上买到什么宠物？请告诉我们..."
                      bindinput='textareaInput'></textarea>
            <div class="text-count">0/500</div>
        </div>
        <div class="fb-mobile">
            <div class="label">手机号码</div>
            <div class="mobile-box">
                <input class="mobile" placeholder="方便我们与你联系" bindinput='mobileInput'/>
                <img alt="优宠熊-手机号" class="clear-icon"
                     src="https://photo.youchongxiong.com/hxm%252Fyanxuan-wap%252Fp%252F20161201%252Fstyle%252Fimg%252Ficon-normal%252Fclear-fb-dd9d604f86.png">
            </div>
        </div>

        <button class="fb-btn" onclick='submitFeedback()'>提交</button>
    </div>
</div>
...
<script>
    ...
    function submitFeedback() {
        ...
        $.post('${base}/webMobile/mobileMine/add', {
            msg: msg,
            phone: phone
        }, function (data) {
