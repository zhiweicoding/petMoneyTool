...
<div class="aui-content-box">
    ...
    <img alt="优宠熊客户好评" src='' id="showImg"
         style='margin-left: 2%;margin-right:2%;width:96%;height:auto;display: none;position: fixed;top:10%;'
         onclick='imgShow()'/>
    <div scroll-y class="orders">
        <#list  resultArray as resultArray>
            <div id='${resultArray.commId}' class="order">
                <div class="h">
                    <div class="l">
                        <img alt="${resultArray.commDesc}评价优宠熊购猫体验"
                             src='${resultArray.avatarUrl}' class='buyerImg' lazy-load mode='aspectFill'/>
                        <div class='buyerDetailBody'>
                            来自${resultArray.commDesc}的用户
                        </div>
                    </div>
                    <div class="r">${resultArray.createTimeStrShort}</div>
                </div>
                <div class="goods">
                    <#list resultArray.imgUrlArray as imgUrlArray>
                        <img class='img'
                             data-original='${imgUrlArray}'
                             src="${base}/resources/img/loadingsmall.jpg"
                             background-size="cover"
                             mode='aspectFill'
                             onclick="imgTap('${imgUrlArray}')">
                    </#list>

                </div>
                <div class="b">
                    <div class="l">品种：${resultArray.symbolName}</div>
                    <div class="r">购买时间：${resultArray.protectTimeStrShort}</div>
                </div>
            </div>
        </#list>
