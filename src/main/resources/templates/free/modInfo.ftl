...
<div class="weui-cells__title">验证申请的手机号码</div>
<div id="msgBox" class="weui-cells weui-cells_form">
    ...
    <div class="weui-cell ">
        ...
        <div class="weui-cell__bd">
            <input id="phoneNum" class="weui-input" type="tel" value="${qBean.phoneNum}" pattern="[1][3-9][0-9]{9}" placeholder="请输入手机号">
        </div>
    </div>
...
<div id="msgBox" class="weui-cells weui-cells_form">
    <div class="weui-cell">
        ...
        <div class="weui-cell__bd">
            <input id="taobaoName" class="weui-input" value="${qBean.taobaoName}" type="text" pattern="[*]{4,35}" placeholder="请输入淘宝会员名">
        </div>
    </div>
</div>
...
<div class="weui-cells__title">绑定返款账号和实名信息</div>
<div id="msgBox" class="weui-cells weui-cells_form">
    ...
    <div class="weui-cell">
        ...
        <div class="weui-cell__bd">
            <input id="zhifubaoName" class="weui-input" value="${qBean.zhifubaoName}" type="text" pattern="[*]{5,}" placeholder="请输入收款账号">
        </div>
    </div>
    <div class="weui-cell">
        <div class="weui-cell__hd"><label class="weui-label">真实姓名</label></div>
        <div class="weui-cell__bd">
            <input id="zhifubaoName" class="weui-input" value="${qBean.realName}" type="text" pattern="[*]{5,}" placeholder="当前支付宝认证的姓名">
        </div>
    </div>
</div>
...
<div class="weui-btn-area">
    <a class="weui-btn weui-btn_primary" href="javascript:saveBind()" id="showTooltips">确认修改</a>
