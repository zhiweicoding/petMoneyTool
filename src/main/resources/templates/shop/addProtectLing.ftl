...
<div class="weui-cells weui-cells_form" style="margin-top: 5px;padding-top: 5px;">
    ...
    <div class="weui-cell" style="display: none;">
        ...
        <div class="weui-cell__bd">
            <input class="weui-input" id="birth" type="text" placeholder="点击选择" value="2021/12/02">
        </div>
    </div>
    <div class="weui-cell" style="display: none;">
        <div class="weui-cell__hd"><label class="weui-label">猫咪市场价</label></div>
        <div class="weui-cell__bd">
            <input id="shichang" name="shichang" class="weui-input" type="number" placeholder="如：3000" value="2500">
        </div>
    </div>
    <div class="weui-cell" style="display: none;">
        <div class="weui-cell__hd"><label class="weui-label">成本费</label></div>
        <div class="weui-cell__bd">
            <input id="chengben" class="weui-input" type="number" placeholder="如：90" value="90">
        </div>
    </div>
    <div class="weui-cell" style="display: none;">
        <div class="weui-cell__hd"><label class="weui-label">保障年份</label></div>
        <div class="weui-cell__bd">
            <input id="year" class="weui-input" type="number" placeholder="如：1" value="1">
        </div>
    </div>
    <div class="weui-cell">
        <div class="weui-cell__hd"><label class="weui-label">定金</label></div>
        <div class="weui-cell__bd">
            <input id="dingjin" class="weui-input" type="number" placeholder="如：500" value="500">
        </div>
    </div>
    <div class="weui-cell">
        <div class="weui-cell__hd"><label class="weui-label">违约金</label></div>
        <div class="weui-cell__bd">
            <input id="weiyue" class="weui-input" type="number" placeholder="如：200" value="200">
        </div>
    </div>
    <div class="weui-cells__title" style="display: none;">疫苗驱虫</div>
    <div class="weui-cell" style="display: none;">
    ...
    <div class="weui-cell" style="display: none;">
        ...
        <div class="weui-cell__bd">
            <input class="weui-input" id="firstV" type="text" placeholder="点击选择" value="2021/12/02">
        </div>
    </div>
    <div class="weui-cell" style="display: none;">
    ...
    <div class="weui-cell" style="display: none;">
        ...
        <div class="weui-cell__bd">
            <input class="weui-input" id="secondV" type="text" placeholder="点击选择" value="2021/12/02">
        </div>
    </div>
    <div class="weui-cell" style="display: none;">
    ...
    <div class="weui-cell" style="display: none;">
        ...
        <div class="weui-cell__bd">
            <input class="weui-input" id="thirdV" type="text" placeholder="点击选择" value="2021/12/02">
        </div>
    </div>
    <div class="weui-cell" style="display: none;">
    ...
    <div class="weui-cell" style="display: none;">
        ...
        <div class="weui-cell__bd">
            <input class="weui-input" id="quchong" type="text" placeholder="点击选择" value="2021/12/02">
        </div>
    </div>
...
<@js.js/>
    ...
    <script>
        ...
        function savePic() {
            ...
            if (!shichang) {
                $.toast("请先填写市场价", "forbidden");
                return false;
            }
            if (!chengben) {
                $.toast("请先填写成本费用", "forbidden");
                return false;
            }
            if (!year) {
                $.toast("请先填写保障年份", "forbidden");
                return false;
            }
            if (!dingjin) {
                $.toast("请先填写定金", "forbidden");
                return false;
            }
            if (!weiyue) {
                $.toast("请先填写违约金", "forbidden");
                return false;
            }
            ...
            formData.append('shichang', shichang)
            formData.append('year', year)
            formData.append('chengben', chengben)
            formData.append('dingjin', dingjin)
            formData.append('weiyue', weiyue)
            ...
            formData.append("symbolId", '151b1abad7c64bd8a2178acaed691ffe')
            ...
            $.ajax({
                url: '${base}/shop/protectPage/addLingDym',
                type: 'POST',
                cache: false,
                data: formData,
                processData: false,
                ...
                success: function (res) {
                    $.hideLoading();
                    if (res.msgCode == 10000) {
                        window.location.replace('${base}/shop/protectPage/protectShareLing?protectId=' + res.msgBody)
