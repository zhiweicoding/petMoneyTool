...
<div class="weui-cells" style="margin-top: 0px;">
    ...
    <div id="cannotwritesomeid" style="display: none;">
        ...
        <div class="weui-cell" id="yimiaoNumId" style="display: none;">
            <div class="weui-cell__bd">
                <p>接种疫苗次数</p>
            </div>
            <div class="weui-cell__ft">
...
<script>
    ...
    function savePic() {
        ...
        $.ajax({
            url: '${base}/shop/adoptPage/addDym',
            type: 'POST',
            cache: false,
            data: formData,
            processData: false,
            ...
            success: function (res) {
                $.hideLoading();
                if (res.msgCode == 10000) {
                    window.location.replace('${base}/shop/msgPage/index?goodId=' + res.msgBody + '&turnPage=2')
                } else if (res.msgCode == 10001) {
