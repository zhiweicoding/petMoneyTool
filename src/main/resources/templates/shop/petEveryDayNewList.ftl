...
<div class="page__pd">
    <div class="weui-search-bar" id="searchBar">
        <form class="weui-search-bar__form" action="${base}/shop/goodPage/everyDayNewList">
...
<script>
        ...
        $.post('${base}/shop/goodPage/querySymbol', {
            ...
            $("#symbolId").picker({
                ...
                onClose: function (p, v, d) {
                    window.location.replace('${base}/shop/goodPage/everyDayNewList?anyText=' + p.displayValue[0])
                }
            });
    ...
    function showAll() {
        window.location.replace('${base}/shop/goodPage/everyDayNewList');
    }
    ...
    function modifySimpleInfo() {
        ...
        $.post('${base}/shop/goodPage/modPetSimpleInfo', {
            ...
            $.hideLoading();
            if (res.msgCode == 10000) {
                window.location.replace('${base}/shop/goodPage/everyDayNewList?anyText=' + goodId)
            } else if (res.msgCode == 10001) {
                $.toast("修改失败", "cancel", function (toast) {
                    console.log(toast);
                });
    ...
    function goodAction(goodId, price, symbolName, gender) {
        $.actions({
            ...
            actions: [{
                ...
                onClick: function () {
                    $.showLoading();
                    $.post('${base}/shop/goodPage/copyTom', {
                        goodId: goodId
                    }, function (res) {
                        $.hideLoading();
                        if (res.msgCode == 10000) {
