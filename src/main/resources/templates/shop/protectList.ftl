    ...
    <div class="weui-panel weui-panel_access">
        <div class="weui-panel__bd">
            <#list beanArray as beanArray>
                <a href="https://www.myloveqian.cn/page/protect/signPageDetail?openId=${beanArray.openId}&protectId=${beanArray.protectId}" class="weui-media-box weui-media-box_appmsg">
                    ...
                    <div class="weui-media-box__bd">
                        ...
                        <p class="weui-media-box__desc" style="margin-bottom: 3px;">销售信息：${beanArray.sellName}-${beanArray.sellPhone}</p>
