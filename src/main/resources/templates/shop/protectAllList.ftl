                ...
                <a href="javascript:queryTaobaoSell('${beanArray.protectId}');"
                   ...
                   data-target="#half">
                    <div class="weui-media-box__hd">
                        ...
                        <#if beanArray.is_delete==0>
                            <#if beanArray.protect_type==1>
                                <span class="weui-badge" style="position: absolute;top: -.4em;right: -.4em;">签署</span>
                            <#else >
                                <span class="weui-badge" style="position: absolute;top: -.4em;right: -.4em;">签署免费</span>
                            </#if>

                        <#else >
                            <span class="weui-badge" style="position: absolute;top: -.4em;right: -.4em;">已作废</span>
                        </#if>
