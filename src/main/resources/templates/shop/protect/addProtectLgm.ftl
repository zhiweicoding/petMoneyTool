...
<div class="weui-cells weui-cells_form" style="margin-top: 5px;padding-top: 5px;">
    ...
    <div class="weui-cell" >
        ...
        <div class="weui-cell__bd">
            <input id="chengben" class="weui-input" type="number" placeholder="如：90" value="">
        </div>
    </div>
...
<@js.js/>
    ...
    <script>
        ...
        function savePic() {
            ...
            $.ajax({
                url: '${base}/shop/protectLPage/addLgmDym',
                type: 'POST',
                cache: false,
                data: formData,
                processData: false,
                ...
                success: function (res) {
                    $.hideLoading();
                    if (res.msgCode == 10000) {
                        window.location.replace('${base}/shop/protectPage/pslgm?protectId=' + res.msgBody)
