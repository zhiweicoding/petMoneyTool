...
<div class="weui-cells weui-cells_form" style="margin-top: 5px;padding-top: 5px;">
    ...
    <div class="weui-cell" >
        ...
        <div class="weui-cell__bd">
            <input id="shichang" name="shichang" class="weui-input" type="number" placeholder="如：3000" value="">
        </div>
    </div>
    <div class="weui-cell" >
        <div class="weui-cell__hd"><label class="weui-label">成本费</label></div>
        <div class="weui-cell__bd">
            <input id="chengben" class="weui-input" type="number" placeholder="如：90" value="0">
        </div>
    </div>
    ...
    <div class="weui-cell" style="display: none;">
        ...
        <div class="weui-cell__bd">
            <input id="dingjin" class="weui-input" type="number" placeholder="如：800" value="800">
        </div>
    </div>
    <div class="weui-cell" style="display: none;">
        <div class="weui-cell__hd"><label class="weui-label">违约金</label></div>
        <div class="weui-cell__bd">
            <input id="weiyue" class="weui-input" type="number" placeholder="如：1500" value="1500">
        </div>
    </div>
...
<@js.js/>
    ...
    <script>
        ...
        function savePic() {
            ...
            $.ajax({
                url: '${base}/shop/protectLPage/addLwmDym',
                type: 'POST',
                cache: false,
                data: formData,
                processData: false,
                ...
                success: function (res) {
                    $.hideLoading();
                    if (res.msgCode == 10000) {
                        window.location.replace('${base}/shop/protectPage/pslwm?protectId=' + res.msgBody)
