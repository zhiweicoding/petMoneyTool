...
<div class="weui-search-bar" id="searchBar">
    <form class="weui-search-bar__form" action="${base}/shop/userListPage/init">
...
<script type="text/javascript" charset="utf-8">
    ...
    function createOrder(userId, phone) {
        $.showLoading();
        $.post('${base}/shop/userListPage/freeGet', {
            userId: userId,
            phone: phone
        }, function (res) {
            $.hideLoading();
    ...
    $(function () {
        ...
        function getListDataFromNet(whichPageNumParams, successCallback, errorCallback) {
            $.showLoading();
            $.post('${base}/shop/userListPage/dymInit', {
