            ...
            <div class="weui-uploader">
                ...
                <div class="weui-uploader__bd">
                    ...
                    <div class="weui-uploader__input-box">
                        <input id="uploaderInputVideo" class="weui-uploader__input" type="file" accept="image/*">
                    </div>
                ...
                if (res.msgCode == 10000) {
                    ...
                    var observer = {                         //设置上传过程的监听函数
                        ...
                        complete(res1) {                      //成功后
                            ...
                            var imgUrl = 'https://photo.youchongxiong.com/' + res.msgBody.fileName
    ...
    function savePic() {
        ...
        if (parseFloat(money) < 1000) {
            $.confirm("价格小于1000，请确定价格没有问题!", "确认上传", function () {
                $.showLoading();
                $.ajax({
                    url: '${base}/shop/goodTempPage/addPhotoDym',
                    type: 'POST',
                    cache: false,
                    data: formData,
                    processData: false,
