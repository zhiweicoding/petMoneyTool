...
<div class="weui-cells weui-cells_form" style="margin-top: 5px;padding-top: 5px;">
    ...
    <div class="weui-cell">
        <div class="weui-cell__hd"><label class="weui-label">额外费用</label></div>
        <div class="weui-cell__bd">
            <input id="extMoney" class="weui-input" type="number" placeholder="如：3000">
        </div>
    </div>
...
<div class="weui-cells" style="margin-top: 0px;">
    ...
    <div id="cannotwritesomeid" style="display: none;">
        ...
        <div class="weui-cell weui-cell_switch">
            <div class="weui-cell__bd">上传每日上新</div>
            <div class="weui-cell__ft">
                <label for="newCP" class="weui-switch-cp">
                    <input id="newCP" class="weui-switch-cp__input" type="checkbox" >
                    <div class="weui-switch-cp__box"></div>
                </label>
            </div>
        </div>
