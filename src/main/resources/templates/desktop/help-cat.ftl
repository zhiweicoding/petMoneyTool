        ...
        <div class="g-row">
            <div style="margin-bottom: -20px;">
                <div class="m-crumbs " id="j-yx-crumbs" style="display: block;">
                    ...
                    <span class="z-cur">帮助中心</span>
                </div>
            </div>
            <div class="g-sub">
                <div class="m-help" id="helpList" style="">
                    <dl class="help on">
                        <dt class="title">
                            <a href="javascript:;" class="parents">服务协议</a>
                            <b class="w-icon-arrow arrow-up-hollow"></b>
                        </dt>
                        <dd class="help-cnt">
                            <ul class="help-list">
                                <li class="list-item">
                                    <a href="/help/dog" data-id="agreement">消费者保障协议-狗</a>
                                </li>
                                <li class="list-item">
                                    <a href="#" data-id="overseaAgreement" class="cur">购猫协议</a>
                                </li>
                                <li class="list-item">
                                    <a href="/help/cathalf" data-id="overseaAgreement">半价购猫协议</a>
                                </li>
                            </ul>
                        </dd>
                    </dl>
            ...
            <div class="g-main">
                <div id="main">
                    <div class="m-helpCon">
                        <div class="title">《优宠熊消费者购猫协议》</div>
                        <div class="content indent">
                            <p>为了保障您（以下简称“用户”）的权益， 请在使用优宠熊服务之前，详细阅读此服务协议（以下简称“本协议”）所有内容，特别是加粗部分。
                                <strong>本合同依据《中华人民共和国民法典-合同编》及有关法律、法规的规定。当用户开始使用优宠熊服务，用户的行为表示用户同意并签署了本协议，构成用户与平台之间的协议，具有合同效力。</strong>
                            </p>
                            <p><strong>猫舍（甲方）：</strong>某某家庭繁育猫舍</p>
                            <p><strong>地址：</strong></p>
                            <p><strong>联系电话：</strong>1XXXXXXXXX0</p>
                            <p style="height:auto;vertical-align: middle; display: none;">
                                <strong>签字:&nbsp;&nbsp;XXX</strong>
                            </p>
                            <br/>
                            <p><strong>购猫人（乙方）：</strong>张三</p>
                            <p><strong>联系电话：</strong>1XXXXXXXXX0</p>
                            <br/>
                            <p><strong>优宠熊平台（丙方）：</strong>天津优宠科技有限公司</p>
                            <p>地址：天津市西青区中北产业园区</p>
                            <p>联系电话：17622655171</p>
                            <p><strong>公章: </strong><img
                                        src="https://lg-qrm18qcm-1255940368.cos.ap-shanghai.myqcloud.com/youchongxiong4.jpg"
                                        width="100"
                                        height="96"/></p>
                            <br/>
                            ...
                            <div>
                                <section>
                                    ...
                                    <section>
                                        ...
                                        <p>猫咪性别:示例：弟弟</p>
                                        <p>购买价格:示例：2600</p>
                                        <p>出生日期:示例：2019-3-4</p>
                                        <p>一次疫苗时间:示例：2019-5-9</p>
                                        <p>一次疫苗药物:示例：妙三多</p>
                                        <p>二次疫苗时间:示例：2019-5-3</p>
                                        <p>二次疫苗药物:示例：妙三多</p>
                                        <p>三次疫苗时间:示例：2019-6-20</p>
                                        <p>三次疫苗药物:示例：妙三多</p>
                                        <p>驱虫时间:示例：2019-5-9</p>
                                        <p>驱虫药物:示例：拜耳</p>
                                        <p>签订时间:示例：2019-6-1</p>
                                    </section>
                                </section>
                                <section>
                                    <h2 class="title">第二条 平台职责</h2>
                                    <section>
                                        <p>1、平台为所售卖的猫咪购买了三个月中国平安财险北京分公司的宠物保险。</p>
                                        <p>2、平台需监督甲方猫舍按照协议内容为用户提供保障。</p>
                                        <p>3、平台需提醒乙方按照甲方规定的方式照顾猫咪。</p>
                                        <p>4、平台应提供具备职业兽医资格证的养宠顾问为用户照顾猫咪提供问询服务。</p>
                                    </section>
                                </section>
                                <section>
                                    ...
                                    <section>
                                        ...
                                        <p>7、乙方自接猫当日起享受甲方提供的7天购宠保障（如保障期间内出现第四条第一点规定的疾病致死 甲方应为乙方赠送一只同品质猫咪）
                                        </p>
                                    </section>
                                </section>
                                <section>
                                ...
                                <section>
                                    ...
                                    <section>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                在本协议约定的售后保障期内，乙方如发现猫咪健康状况异常，第一时间联系甲方，而甲方没有对给出任何处理建议的，乙方应第一时间联系丙方，由丙方督促甲方完成协议约定内容。
                                            </li>
                                            <li>乙方在<strong>接到宠物时应及时检测猫瘟、猫传染性腹膜炎。</strong>如发现确有感染，应第一时间联系甲方理赔；</li>
                                        </ul>

                                        <p>2、自乙方接到宠物之日起7日内，若宠物出现第四条第1点规定的两种疾病时： <strong>乙方应第一时间联系甲方</strong>依次履行售后保障服务：
                                        </p>
                                        <ul>
                                        ...
                                        <p>4、除第三条第2点情况外，乙方对猫咪的治疗、诊疗、体检费用均由乙方自行承担。</p>
                                        ...
                                        <p>8、反馈时间以联系养宠顾问时间为准。</p>
                                    </section>
                                </section>
                                <section>
                                    <h2 class="title">第六条 协议内容及生效</h2>
                                    <section>
                                        <p>
                                            1、本协议内容包括协议正文及所有丙方已经发布或将来可能发布的与“消费者保障协议”相关的规则。前述规则为本协议不可分割的组成部分，与协议正文具有同等法律效力。</p>
                                ...
                                <section>
                                    <h2 class="title">第九条 丙方的权利及义务</h2>
                                    <section>
                                        <p>1、丙方监督甲方提供猫咪品质。</p>
                                ...
                                <section>
                                    ...
                                    <section>
                                        ...
                                        <p>
                                            5、甲方基于本协议享有的权利以及获得的授权，均可以全部或部分转移、转让、许可、分授权、转授权给任何第三方。未经甲方事先书面同意，您不得将本协议项下的权利义务转让给任何第三方。</p>
