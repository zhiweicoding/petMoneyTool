    ...
    <div>
        ...
        <section>
            ...
            <section>
                ...
                <p>4、乙方在接到猫咪当日，出现猫咪丢失、死亡、需在接到猫咪一个小时内联系甲方和丙方客服。甲方在丙方监督下，与快递托运公司核对后，如乙方所属属实。应在<strong>乙方第一次与甲方沟通后，24小时内赔付全款，不得延误</strong>
                </p>
                <p>5、乙方在接到猫咪当日，出现猫咪肢体残缺、花色明显有误、品种有误（品种有误，除大品种有误，如美短、加菲发错外，乙方需要提供基因检测报告）、性别有误。
                    需在接到猫咪第一个自然日内联系甲方和丙方客服。甲方在丙方监督下，与快递托运公司核对后，如乙方所属属实。应在<strong>乙方第一次与甲方沟通后，24小时内赔付全款或寄送正确的猫咪</strong>（
                ...
                <p>7、因宠物为非标准化特殊商品，在本协议项下预定宠物交付前，若非甲方原因，乙方怠于或拒绝接受该宠物，甲方不退还乙方已支付定金
                    ；若预定宠物因甲方原因导致无法交付，在协商无果的情况下，甲方应退还乙方已支付的定金。</p>
                <p>8、乙方自接猫当日起享受甲方提供的<span style="color: darkred;">${dayTime}天</span>购宠保障。（保障期间内出现第四条第1点规定的疾病致死，甲方应免费更换一只同品质猫咪）
                </p>
        ...
        <section>
            ...
            <section>
                <p>1、<strong>猫瘟、猫传染性腹膜炎</strong>两种疾病属于平台要求甲方质保的疾病</p>
                <p>2、甲方需在第三条第8点规定的的时间内对<strong>猫瘟、猫传染性腹膜炎</strong>两种疾病提供第三条第8条规定的质保服务。</p>
                <p>3、乙方在接到猫咪的<strong>第一天</strong>，应仔细检查猫咪是否有猫癣（购猫前甲方告知乙方已知晓情况除外），如有猫癣，应联系优宠熊官方客服，
        ...
        <section>
            ...
            <section>
                ...
                <p>3、在甲方提供的售后保障期内，乙方如发现宠物健康状况异常(如进食不畅、流鼻涕、鼻子干燥、呕吐、拉稀、眼部分泌物过多、精神不佳、皮肤症状等)，需在对宠物就诊或医治前的第一时间与甲方联系。经甲方确认同意，宠物确需乙方就诊时，乙方应前往甲乙双方均认可的正规动物医院/动物诊疗机构(正规的标准包括但不限于医院/诊疗机构需持有动物诊疗许可证，检验医生具有执业兽医师资格证书)。
                </p>
