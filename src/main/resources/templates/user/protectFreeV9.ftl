...
<article class="weui-article" id="chongwuBody">
    ...
    <div>
        <section>
            ...
            <section>
                ...
                <p>1、平台为所售卖的猫咪提供一份中国平安财险北京分公司的宠物保险。乙方可自愿为猫咪购买</p>
        ...
        <section>
            ...
            <section>
                ...
                <p>7、乙方自接猫当日起享受甲方提供的<span style="color: darkred;">${dayTime}天</span>购宠保障（如保障期间内出现第四条第一点规定的疾病致死 甲方应赔偿乙方购买猫咪费用40%或免费更换一只同品质猫咪）
                </p>
            </section>
        </section>
        <section>
    ...
    <#if protectBean.userId=='902786b8a07547bcb918ff2a453e56fa'>
        <p>备注信息：含WCF证书。另外帮助办理WCF猫舍，材料费购猫方出</p>
    </#if>
</article>
