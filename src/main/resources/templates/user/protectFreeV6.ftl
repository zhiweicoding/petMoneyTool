...
<article class="weui-article" id="chongwuBody">
        ...
        <div class="weui-cells weui-cells_radio" style="margin-bottom: 18px;" onchange="changeProtect()">
            <label class="weui-cell weui-check__label" for="p12">
                ...
                <div class="weui-cell__ft">
                    <input type="radio" name="protectType" class="weui-check" id="p12" >
            ...
            <label class="weui-cell weui-check__label" for="p13">
                ...
                <div class="weui-cell__ft">
                    <input type="radio" name="protectType" class="weui-check" id="p13" checked="checked">
                    <span class="weui-icon-checked"></span>
                </div>
            </label>
        </div>
        <h2 class="title mianfei" style="display: none;">请确认签署保障时间</h2>
        <div class="weui-cells weui-cells_radio mianfei" style="display: none;" onchange="protectTime(2)">
    ...
    <section id="chongwuInfo">
        ...
        <div class="weui-cells weui-cells_form">
            ...
            <div class="weui-cell mianfei" id="zhifubaoBody" style="display: none;">
            ...
            <div class="weui-cell mianfei" id="taobaoBody"  style="display: none;">
            ...
            <div class="weui-cells__tips mianfei " id="linkBody"  style="display: none;">
    ...
    <#--免费-->
        <div class="mianfei" style="display: none;">
            <section>
                <h2 class="title">第二条 价格、附加费用及交付</h2>
                <section>
                    <p>1、运费由第三方宠物运输公司收取。</p>
