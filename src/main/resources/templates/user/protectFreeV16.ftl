    ...
    <div>
        ...
        <section>
            ...
            <section>
                ...
                <p>2、若乙方满足如下全部条件时，甲方为乙方所购宠物提供本协议提供的售后保障服务：</p>
                <ul>
                    <li>乙方需遵照平台服务流程，签订本电子协议；</li>
                    <li>乙方需按照甲方提供的科学喂养方式以及个体猫咪生活习惯<strong>对宠物进行正确喂养</strong>；</li>
                    <li>
                        在本协议约定的售后保障期内，猫咪的健康、疾病、生死是和甲方相关联的、由甲乙双方共同负责。因乙方没有专业饲养经验、为保障猫咪生命安全、乙方不得擅自对宠物进行就诊或医治，乙方应在宠物出现健康状态异常后第一时间联系甲方进行协商处理，否则视为乙方违约，甲方有权拒绝履行售后保障服务、有权追究乙方私自处理不周导致猫咪疾病死亡等法律责任。乙方自行承担因擅自就医造成的诊疗、药物、护理、死亡等一切费用及责任，与甲方无关。
                    </li>
