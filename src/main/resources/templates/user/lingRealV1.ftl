    ...
    <section style="width: 100%">
        ...
        <div class="sureLine" style="padding: 0 0 10px 0;">
            ...
            <div class="sureRight">
                <#if protectBean.isProtect==1>
                    <#if remarkMsg.ten=='y'>
                        <label style="margin-right: 20px;"><input name="ten" type="radio" value="y" checked="checked" disabled
                            />是</label>
            ...
            <div class="sureRight">
                ...
                <#if protectBean.isProtect==1>
                    <#if remarkMsg.eleven=='y'>
                        <label style="margin-right: 20px;"><input name="eleven" type="radio" value="y" checked="checked" disabled
                            />是</label>
        ...
        <div class="sureLine" style="padding: 0 0 10px 0;">
            ...
            <div class="sureRight">
                <#if protectBean.isProtect==1>
                    <#if remarkMsg.tw=='y'>
                        <label style="margin-right: 20px;"><input name="tw" type="radio" value="y" checked="checked" disabled
                            />是</label>
