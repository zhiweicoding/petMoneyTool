...
<head>
    ...
    <link rel="stylesheet" href="/resources/shopCss/jquery-weui.min.css">
    <link rel="stylesheet" href="/resources/shopCss/demos.css"/>
    <style type="text/css">
    ...
    <script src="https://photo.youchongxiong.com/clipboard.min.js"></script>
</head>
<body ontouchstart>
...
<article class="weui-article" id="chongwuBody">
    ...
    <div class="Section0" style="layout-grid:15.6000pt;">
        <p class=MsoNormal>
            ...
            <span class='specialSpan'>天津市南开区领猫猫宠物销售店</span>
        </p>
        <p class=MsoNormal>
        ...
        <p class=MsoNormal>
            ...
            <span class='specialSpan'>天津市南开区天拖兰坪路63号</span>
        </p>
        ...
        <h3><span>二、乙方自愿接受领养甲方宠物，并承诺保证有经济能力饲养该宠物。</span></h3>
        <p class=MsoNormal><span style="font-weight:bold;">三、领养条件</span></p>
        <p class=MsoNormal><span>(一)、乙方喜爱猫咪、承诺有经济能力为猫咪生活负责。</span></p>
        ...
        <p class=MsoNormal><span>(一)、在接收前，乙方有权向甲方咨询该宠物的生活健康状况、性格和爱好等真实情况。</span></p>
        ...
        <p class=MsoNormal><span>(六)、不得给宠物实施不人道且不必要的手术，如：去爪，拨齿，及截耳断尾等。</span></p>
        <p class=MsoNormal><span>(七)、带宠物出门必须做好安全措施，如拴好牵引绳，不得遗失，逃走。</span></p>
        <p class=MsoNormal><span>(八)、宠物年迈之日乙方应妥善照顾直到正常自然死亡，但不得抛尸、食用或者变卖。</span></p>
        ...
        <p class=MsoNormal>
            <span>(三)、宠物交付后，由于宠物侵袭等原因造成他人人身或者财产损害的，由乙方 承担责任，甲方不承担责任。宠物交付后，由于宠物自身生病等原因产生的医疗费用，由乙方承担，甲方不承担。</span></p>
        <p class=MsoNormal><span>(四)、甲方若不交付宠物，乙方可以要求其交付。</span></p>
        ...
        <p class=MsoNormal><span>(三)、乙方没有履约的、甲方将冻结账户余额并将失信信息送往国家征信部门，到履约为止。</span></p>
        <p class=MsoNormal><span style="font-weight:bold;">八、关于解约</span></p>
        <p class=MsoNormal><span>(一)、如乙方没有将宠物送回甲方，需要解约的：</p>
        <p class=MsoNormal><span>1、猫咪正常生活、在乙方向甲方支付了猫咪市场价后可在3个工作日内正常解约。</p>
        <p class=MsoNormal><span>2、猫咪疾病以及死亡的、出于人文关怀在乙方向甲方支付了猫咪市场价格一半后、可在3个工作日内正常解约。</p>
        <p class=MsoNormal><span>(二)、如乙方将宠物送回甲方(运费自理)，需要解约的：</span></p>
        <p class=MsoNormal><span>1、在猫咪健康的前提下：</p>
        <p class=MsoNormal><span>(1)、15（15x24小时）天以内，乙方单方面提出解约、违约金800，3个工作日内正常解约。</p>
        <p class=MsoNormal><span>(2)、15（15x24小时）天即半个月以后，乙方单方面提出解约的、由于猫咪身体长相都已发生变化，大月份猫咪无法二次领养或者出售、因此在乙方支付猫咪市场价后、3个工作日内正常解约。</p>
        <p class=MsoNormal><span>2、猫咪不健康或已死亡：</p>
        <p class=MsoNormal><span>(1)、出于人文关怀在乙方向甲方支付了猫咪市场价格一半后、可在3个工作日内正常解约。</p>
        <p class=MsoNormal><span style="font-weight:bold;">九、关于退费</span></p>
        <p class=MsoNormal><span>（一）、猫粮保障计划中猫粮猫砂费用属于乙方分期购买的用品费用、跟猫咪没有关系、猫咪本身属于免费赠送不存在消费行为，除本合同第八条规定外、均不退款。</span></p>
        ...
        <p class=MsoNormal><span>(一)、本协议自签订之日起生效、任何一方有违约的行为，另一方可单方面解除本合同。</span></p>
        <p class=MsoNormal><span>(二)、若发生纠纷、在没有合法解决的情况下，预存账户余额暂时冻结直到解决。</span></p>
...
<script src="/resources/shopJs/jquery.min.js"></script>
<script src="/resources/shopJs/fastclick.min.js"></script>
<script>
    $(function () {
        FastClick.attach(document.body);
    });
</script>
<script src="/resources/shopJs/jquery-weui.min.js"></script>
<script src="/resources/shopJs/swiper.min.js"></script>
                ...
                if (input != '本人已知晓以上所有内容自愿承担一切风险及后果') {
                    ...
                    $.post('/si/pr/upLwmV2', {
                        ...
                        if (res.msgCode == 10000) {
                            ...
                            window.location.replace('/si/pr/signSuccess')
                        } else {
                            $.toast("签署失败", "cancel");
                        }
