...
<article class="weui-article">
    ...
    <section>
        ...
        <section>
            <p>1、运费由第三方宠物运输公司收取，若乙方在接到猫咪当天检测到猫瘟，更换产生的二次物流费用由甲方支付；其他更换产生的二次物流费用，由乙方支付。</p>
            ...
            <p>
                5、自宠物交付之日起：乙方在周语宠物体验店返现专区购买猫粮、猫砂、赖氨酸等宠物用品，丙方应在乙方每次购物确认收货24小时内将等于乙方消费金额的现金以转账的形式返还到乙方指定账户中，累计返还金额等于实际购猫费用时，返现结束</p>
    ...
    <section>
        ...
        <section>
            ...
            <ul>
                ...
                <li>甲方需为乙方提供以下两种解决方案，供乙方选择其一。
                    <p>方法一：更换同等价位宠物一只，并结束返现，丙方不应再收取更换的猫咪的费用；</p>
                    <p>方法二：甲方为乙方免费提供救治爱心基金（爱心基金梯度见本协议第三条第3点），供乙方宠物治疗，并结束返现。</p>
                    <p>乙方从两种方法中选择一种解决方案，另一种方案自动作废。</p>
                </li>
            </ul>
            <p>
                3、爱心基金梯度
            </p>
            <table style="width: 100%;border-collapse:collapse;border:none;" align="center" border="0" cellspacing="0"
                   cellpadding="0">
                <thead>
                <tr style="width: 100%;">
                    <th style="width: 60%">购买猫咪的费用</th>
                    <th>基金福利</th>
                </tr>
                </thead>
                <tbody>
                <tr style="width: 100%;">
                    <td style="width: 60%">1-2000元</td>
                    <td>600元</td>
                </tr>
                <tr style="width: 100%;">
                    <td style="width: 60%">2001-5000元</td>
                    <td>800元</td>
                </tr>
                <tr style="width: 100%;">
                    <td style="width: 60%">5001-10000元</td>
                    <td>2000元</td>
                </tr>
                <tr style="width: 100%;">
                    <td style="width: 60%">10001-20000元</td>
                    <td>3000元</td>
                </tr>
                <tr style="width: 100%;">
                    <td style="width: 60%">20001元+</td>
                    <td>5000元</td>
                </tr>
                </tbody>
            ...
            <p>
                5、除上述第2条中约定的2种重大疾病以外，由于环境改变，造成的常见应激反应如：环境过敏、流眼泪、过敏、呕吐、拉稀等；
            ...
            <p>7、乙方应妥善照顾猫咪，猫咪非自然死亡后，停止返现，返现活动终止。</p>
            <p>8、本协议所提供保障服务只针对乙方本人生效，乙方需通过身份信息核实方可获得本协议所提供的保障服务。</p>
        </section>
    </section>
    ...
    <#if protectBean.userId=='996d4493ae734a4381b9195b1d0dbe6f'>
        <p>补充说明：甲方承诺，若乙方猫咪检测出猫传染性腹膜炎，应第一时间联系甲方，甲方免费为乙方更换一只相同品质的猫咪。承诺对此猫咪终身有效</p>
    </#if>
</article>
