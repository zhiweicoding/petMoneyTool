...
<article class="weui-article" id="chongwuBody">
	...
	<div class="Section0" style="layout-grid:15.6000pt;">
        ...
        <p class=MsoNormal><span style="font-weight:bold;">四、其他费用</span><span style="font-weight:bold;"></span></p>
		 <#--  <p class=MsoNormal style="text-align:left;"><span>(一)、领养差价：</span><span></span>
            <span class='specialSpan'>${protectBean.dingjin}</span>
            <span class='specialSpan'>（大写：</span>
            <span class='specialSpan'> ${protectBean.dingjinU}</span>
            <span>）。</span>
        </p>  -->
        <p class=MsoNormal style="text-align:left;"><span>(一)、猫粮、猫砂、罐头、运输等成本费：</span><span></span>
