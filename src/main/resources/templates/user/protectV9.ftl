    ...
    <div>
        <section>
            ...
            <section>
                ...
                <p>3、平台应提供具备职业兽医资格证的养宠顾问为用户照顾猫咪提供问询服务。</p>
            </section>
        </section>
        <section>
            ...
            <section>
                ...
                <p>7、<strong>乙方自<span style="color: darkred;">接猫当日</span></strong>享受甲方提供的接到猫咪当天的购宠保障（如保障期间内出现第四条第一点规定的疾病致死 甲方应赔偿乙方购买猫咪费用40%或免费更换一只同品质猫咪）
                </p>
            </section>
        </section>
        <section>
