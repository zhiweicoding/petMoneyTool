...
<article class="weui-article" id="chongwuBody">
    ...
    <br/>
    <#if noSign==0 >
        <h2 class="title zhengchang">选择签署保障时间</h2>
        <div class="weui-cells weui-cells_radio zhengchang" onchange="protectTime(3)">
            <label class="weui-cell weui-check__label" for="x11zhengchang">
                <div class="weui-cell__bd">
                    <p>30天免费保障（<strong>赔偿购猫费用50%或赠送一只同品质猫咪</strong>)</p>
                </div>
            ...
            <label class="weui-cell weui-check__label" for="x12zhengchang">
                ...
                <div class="weui-cell__bd">
                    <p>延长至60天（<strong>支付宠物费用的20%，赔偿购猫费用80%或免费更换一只同品质猫咪</strong>）</p>
                </div>
                <div class="weui-cell__ft">
            ...
            <label class="weui-cell weui-check__label" for="x13zhengchang">
                ...
                <div class="weui-cell__bd">
                    <p>延长至90天（<strong>支付宠物费用的40%，赔偿购猫全款或免费更换一只同品质的猫咪</strong>）</p>
                </div>
                <div class="weui-cell__ft">
                    <input type="radio" name="noSignZhengchang" class="weui-check"
                           id="x13zhengchang">
    ...
    <div>
        <section>
            ...
            <section>
                <p>1、运费由第三方宠物运输公司收取。运输时间由甲方和快递沟通后，第一时间告知乙方，经得乙方同意后，运送宠物。</p>
                <p>2、交付时间：以实际交付时间为准。接到猫咪当日为一个自然日</p>
                <p>3、宠物经过旅途劳顿，应得到妥善的休息，乙方应提前准备猫粮、猫砂等用品。</p>
                <p>4、乙方可自由选择丙方提供本地协议第三条第2点。30天购宠保障（赔偿购买猫咪费用50%或免费赔偿一只同品质猫咪），
                    也可以选择升级保障期至60天（支付宠物费用20%，赔偿购买猫咪费用80%或免费赔偿一只同品质猫咪）；
                    升级保障期至90天（支付宠物费用40%，全额赔付购买猫咪费用或免费赔偿一只同品质猫咪）
                </p>
                <p>5、在接到猫咪时出现猫咪丢失、死亡、肢体残缺、花色明显有误、品种、性别有误，应第一时间联系优宠熊的官方客服。
                    ...
                    更换正确猫咪并承担所有运费或退全款并承担所有运费，同时甲方需支付给乙方检测期间照顾猫咪花费的猫粮，猫砂成本，检测成本由乙方承担）。
                </p>
                <p>6、自宠物交付定金之日起：甲方可不接受非本协议第三条售后保障承诺约定范围退宠、换宠、退定金行为。</p>
            </section>
        </section>
        <section>
            <h2 class="title">第三条 疾病</h2>
            <section>
                <p>1、<strong>猫瘟、猫传染性腹膜炎</strong>两种疾病属于质保范围内的疾病，甲方需在质保期内对两种疾病提供质保服务。</p>
        ...
        <section>
            ...
            <section>
                ...
                <ul>
                    ...
                    <li>在本协议约定的售后保障期内，乙方不得擅自对宠物进行就诊或医治，乙方应在宠物出现健康状态异常后第一时间联系甲方进行处理，否则是视为乙方违约，甲方有权拒绝履行售后保障服务，乙方自行承担因擅自就医造成的诊疗、药物、护理、死亡等一切费用及责任，与甲方无关。</li>
                ...
                <ul>
                    ...
                    <li>正规宠物医院的FPV测板结果</li><li>主治医生执业兽医师资格证照片</li>
                </ul>
                <p>
    ...
    <#if protectBean.userId=='b4c2a606139b4e73b286bb512c814fcf'>
        <p>补充说明：甲方承诺，若现在猫嘴部附近的猫癣无法恢复健康状态，会退还乙方支付的猫咪费用。承诺对此猫咪终身有效</p>
    </#if>
</article>
...
<script>
    ...
    function protectTime() {
        ...
        var p1 = $('#x11zhengchang').is(':checked');
        var p2 = $('#x12zhengchang').is(':checked');
        var p3 = $('#x13zhengchang').is(':checked');
        if (p1) {
            $('#dayTime').html('30')
            dayTimeInt = 30
        }
    ...
    function updateData() {
        ...
        if (dayTimeInt == 30) {
            dayTime = 30
            dayTimeStr = '30天免费保障'
        } else if (dayTimeInt == 60) {
            dayTime = 60
            dayTimeStr = '60天保障（需支付购猫费用的20%）'
        } else if (dayTimeInt == 90) {
            dayTime = 90
            dayTimeStr = '90天保障（需支付购猫费用的40%）'
        }
        ...
        $.confirm("您选择的是" + dayTimeStr + ",祝您购猫愉快", "请确认信息", function () {
            $.showLoading('签署中..')
