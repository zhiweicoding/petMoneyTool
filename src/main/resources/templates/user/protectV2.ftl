...
<article class="weui-article">
    ...
    <section>
        ...
        <section>
            ...
            <p>4、自宠物交付之日起：甲方不接受非本协议第二条售后保障承诺约定范围退宠、换宠</p>
        </section>
    </section>
    <section>
        ...
        <section>
            ...
            <p>
                4、除上述第2条中约定的2种重大疾病以外，由于环境改变，造成的常见应激反应如：环境过敏、流眼泪、过敏、呕吐、拉稀等； 宠物常见普通疾病如：先天性疾病、基因遗传性疾病、皮肤病（耳螨、真菌感染、藓类等）、普通感冒、普通肠道疾病、关节疾病、毛色的改变(甲方故意染色情况除外)、体型的大小<strong>均不在甲方赔付范围</strong>， 但甲方须对此类病症提供诊断方案或治疗建议。
            </p>
...
<#if noSign==0>
    <div class="weui-btn-area" style="margin:0;width: 100%; position: fixed; bottom: 0%;z-index: 999">
...
<script>
    ...
    function updateData() {
        ...
        $.confirm("您选择的是" + dayTimeStr, "请确认信息", function () {
