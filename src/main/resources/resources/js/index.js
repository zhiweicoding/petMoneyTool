webpackJsonp([14], {
                    ...
                    if (4 === v.readyState)
                        if (200 === v.status) {
                            try {
                                ...
                                return v.customError = e, v.parseError = !0, v.xtime = Date.now() - w, v.statechange = v.status, v.errortime = o("__t", l), void p(v)
                            }
                            h && h(e), f && f(e)
                        } else v.xtime = Date.now() - w, v.statechange = v.status, v.errortime = o("__t", l), p(v)
                ...
                try {
                    if ("POST" === a) {
                        if (n(m, function (e) {
                            ...
                            var x;
                            d.headers && "application/json" === (x = d.headers["Content-Type"]) ? (i = JSON.stringify(m), v.setRequestHeader("Content-Type", x)) : (i = s(m), v.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"))
                        }
                    ...
                    var n = e.extend({
                        ...
                        s = function (e) {
                            a.layer && (a.layer.css({
                                ...
                                top: (i.height() - a.popupWp.height()) / 2 / 1.236,
                                left: (i.width() - a.popupWp.width()) / 2
                            })
                        },
                        c = function () {
                            a.layer.hide(), a.popupWp.html("").remove(), n.onClose && n.onClose()
                        },
                        u = function () {
                            a.layer ? a.layer.show() : (a.layer = e('<div id="popup-layer" class="popup-layer"></div>').hide(), s(a.layer), a.layer.css({
                                opacity: n.opacity
                            }).appendTo(o).show()), n.clickToHide && a.layer.bind("click", function () {
                                c()
                            })
                        },
                        l = function (t) {
                            ...
                            n.content ? o += n.content.call(t) : o += "Put some texts here.", n.title && (r += '<h3 class="popup-title">' + n.title + "</h3>"), n.closeBtn && (r += '<a href="javascript:;" class="popop-close">&times;</a>'), r += '<div class="pop-content" id="pop-content">' + o + "</div></div>", a.popupWp = e(r).appendTo("body").css({
                                top: 0,
                                left: 0
                            }), s(), a.popupWp.show(), n.onOpen && n.onOpen.call(t), a.popupWp.find(".popop-close").bind("click", c)
                        },
                        f = function (e) {
                            n.showMask ? (u(), setTimeout(function () {
                                l(e)
                            }, 10)) : l(e)
                        };
                    window.closePopup = c, e.fn.disabledPopup = function () {
    ...
    258: function (e, t, n) {
        ...
        r(function () {
            function e(t, n, o) {
                if (!(o < 0)) {
                    var i = n - r(window).scrollTop(),
                        a = i / o * 10;
                    setTimeout(function () {
                        isNaN(parseInt(a, 10)) || (window.scrollTo(0, r(window).scrollTop() + a), e(t, n, o - 10))
                    }.bind(this), 10)
                }
            }
            var t = o.getViewData() || {},
                n = navigator.userAgent,
                s = n.match(/AppleWebKit.*Mobile.*/),
                c = !1;
            r(".full-btn").click(function (e) {
                if ("micromessenger" == n.toLowerCase().match(/MicroMessenger/i)) return c || (r.fn.popup(), r.fn.setPopup({
                    content: function () {
                        return r("#wx-download-popup").val()
                    },
                    onClose: function () {
                        r(".wx-popup").show(), c = !1
                    },
                    maskOpacity: .4,
                    popopClass: "mobile-popup wx-dialog",
                    onOpen: function () {
                        r(".wx-popup").hide(), r(".wx-dialog").find(".close").click(function () {
                            closePopup(), ga("send", "event", "semtest", "installbtn", "close")
                        }), ga("send", "event", "semtest", "open")
                    }
                }), r.fn.showPopup(), c = !0), !1;
                a.download(a.f.getBy(r(this)))
            });
            var u = function (e) {
                if ("undefined" != typeof ga && ga) {
                    var t, n, r, o;
                    if (e) return n = e.category || "", t = e.action || "", r = e.label || "", o = e.value || 0, ga("send", "event", n, t, r, o)
                }
            };
            void 0 !== window.campaignPlugin && window.campaignPlugin && r(".btn").on("click", function (e) {
                e.preventDefault(), campaignPlugin.openInBrowser(r(this).attr("href"))
            });
            var l = i.getQueryString("utm_source") || i.cookie.get("utm_source"),
                f = i.getQueryString("utm_campaign") || i.cookie.get("utm_campaign"),
                p = i.getQueryString("utm_medium") || i.cookie.get("utm_medium");
            if (f && l && "cpc" == p && s) {
                var d = "//ucan.25pp.com/Wandoujia_" + l + "_" + f + "_wap.apk";
                !p || "wx_baidu" != l && "wx_sg" != l && "wx_sm" != l || (d = "//ucan.25pp.com/Wandoujia_" + l + "_" + f + "_download.apk"), r(".main-source").attr("href", d)
            } else {
                var h = document.referrer,
                    g = "direct";
                h.match(/baidu/g) ? g = "seo_baidu" : h.match(/wandoujia/g) ? g = "inner_referral" : h.match(/google/g) ? g = "seo_google" : h.match(/bing/g) || h.match(/sogou/g) || h.match(/so/g) || h.match(/haosou/g) || h.match(/sm/g) || h.match(/yahoo/g) ? g = "seo_others" : h && (g = "referral");
                for (var m, y = r(".main-source"), v = "", w = "", x = "", b = 0; b < y.length; b++) m = r(y[b]), v = m.data("oe"), x = m.data("type"), w = m.data("feat"), m.attr("href"), m && v && w && x && "wdj" === x && m.attr("href", "//ucan.25pp.com/Wandoujia_" + v + "_" + g + "_" + w + ".apk")
            }(function (e) {
                var t = new RegExp("(^|&)" + e + "=([^&]*)(&|$)"),
                    n = location.search.substr(1).match(t);
                return n ? unescape(n[2]) : null
            })("qr") && ("micromessenger" == n.toLowerCase().match(/MicroMessenger/i) ? (r.fn.popup(), r.fn.setPopup({
                content: function () {
                    return r("#wx-download-popup").val()
                },
                onClose: function () {
            ...
            }), r.fn.showPopup()) : location.href = "//ucan.25pp.com/Wandoujia_wandoujia_qrcode.apk"), "undefined" != typeof ga && ga && r("a[data-track], span[data-track]").on("click", function (e) {
                var t = r(this).data("track"),
                    n = t.split("/");
                n.length > 2 && u({
                    category: n[0],
                    action: n[1],
            ...
            var _, T, A = !0,
                ...
                S = "",
                k = function (e) {
                    for (b = 0; b < e.length; b++) _ = r(e[b]), S = _.data("src"), S = S.replace("http://img.wdjimg.com", "//st.wdjcdn.com"), _.attr("src", S)
                };
            r(".tab-nav-li").on("click", function () {
                r(".tab-nav-li").removeClass("current"), r(this).addClass("current");
                var e = r(this).attr("id");
                "awards" === e ? (r(".explore").hide(), r(".tops").hide(), r(".awards").show(), A && (T = r(".awards").find("img"), k(T), A = !1)) : "tops" === e ? (r(".explore").hide(), r(".awards").hide(), r(".tops").show(), E && (T = r(".tops").find("img"), k(T), E = !1)) : (r(".awards").hide(), r(".tops").hide(), r(".explore").show())
            });
            var C = !1;
            r(window).on("scroll", function () {
                C || (T = r(".explore").find("img"), k(T), C = !0, r("body").off("scroll"))
            }), r(".learn-more").on("click", function (t) {
                t.preventDefault(), e(r(window), r("body").height() - 56, 300)
            }), r(".qr-btn").on("mouseenter", function () {
                r(this).next(".qr-btn-popup").show()
            }).on("mouseleave", function () {
                r(this).next(".qr-btn-popup").hide()
            }), r(".search-form").submit(function (e) {
                "" != r(".search-ipt").val() && (location.href = (t.server || "") + "/search?key=" + r(".search-ipt").val() + "&source=index")
            }), a.pageview()
        })
    },
    26: function (e, t, n) {
        ...
        ! function (e) {
            ...
            S.href = window.location.href, e.active = 0, e.ajaxJSONP = function (t, n) {
                ...
                if (k.setRequestHeader = T, k.onreadystatechange = function () {
                        if (4 == k.readyState) {
                            k.onreadystatechange = l, clearTimeout(x);
                            var t, n = !1;
        ...
        ! function (e) {
            ...
            function s(n, o, s, c, l, p, d) {
                ...
                o.split(/\s/).forEach(function (t) {
                    ...
                    var o = r(t);
                    o.fn = s, o.sel = l, o.e in x && (s = function (t) {
    ...
    3: function (e, t, n) {
        ...
        ! function (t, n) {
            ...
            function v(e) {
                return e.replace(Ue, "ms-").replace(We, y)
            }
            ...
            function _(e, t, n, r) {
                var o, i, a = 20,
                    ...
                    l = (Ee.cssNumber[t] || "px" !== u && +c) && Ye.exec(Ee.css(e, t));
                if (l && l[3] !== u) {
            ...
            function A(e, t) {
                for (var n, r, o = [], i = 0, a = e.length; i < a; i++) r = e[i], r.style && (n = r.style.display, t ? ("none" === n && (o[i] = Be.get(r, "display") || null, o[i] || (r.style.display = "")), "" === r.style.display && Ke(r) && (o[i] = T(r))) : "none" !== n && (o[i] = "none", Be.set(r, "display", n)));
            ...
            function q(e, t, n, r) {
                ...
                if (p && (o = k(t, e[0].ownerDocument, !1, e, r), i = o.firstChild, 1 === o.childNodes.length && (o = i), i || r)) {
                    ...
                    if (c)
                        for (l = s[s.length - 1].ownerDocument, Ee.map(s, j), f = 0; f < c; f++) u = s[f], tt.test(u.type || "") && !Be.access(u, "globalEval") && Ee.contains(l, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? Ee._evalUrl && Ee._evalUrl(u.src) : a(u.textContent.replace(ft, ""), l, u))
                }
                return e
            }
            ...
            function $(e, t, n, r, o, i) {
                ...
                for (; a < 4; a += 2) "margin" === n && (c += Ee.css(e, n + Xe[a], !0, o)), r ? ("content" === n && (c -= Ee.css(e, "padding" + Xe[a], !0, o)), "margin" !== n && (c -= Ee.css(e, "border" + Xe[a] + "Width", !0, o))) : (c += Ee.css(e, "padding" + Xe[a], !0, o), "padding" !== n ? c += Ee.css(e, "border" + Xe[a] + "Width", !0, o) : s += Ee.css(e, "border" + Xe[a] + "Width", !0, o));
            ...
            function V() {
                _t && (!1 === le.hidden && n.requestAnimationFrame ? n.requestAnimationFrame(V) : n.setTimeout(V, Ee.fx.interval), Ee.fx.tick())
            }
            ...
            function J(e, t, n) {
                ...
                if ((c = !Ee.isEmptyObject(t)) || !Ee.isEmptyObject(d)) {
                    f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], u = m && m.display, null == u && (u = Be.get(e, "display")), l = Ee.css(e, "display"), "none" === l && (u ? l = u : (A([e], !0), u = e.style.display || u, l = Ee.css(e, "display"), A([e]))), ("inline" === l || "inline-block" === l && null != u) && "none" === Ee.css(e, "float") && (c || (p.done(function () {
                        h.display = u
            ...
            function Z(e, t, n) {
                var r, o, i = 0,
                    ...
                    c = function () {
                        if (o) return !1;
                        for (var t = bt || Y(), n = Math.max(0, u.startTime + u.duration - t), r = n / u.duration || 0, i = 1 - r, a = 0, c = u.tweens.length; a < c; a++) u.tweens[a].run(i);
            ...
            Ee.fn = Ee.prototype = {
                ...
                isPlainObject: function (e) {
                    var t, n;
                    return !(!e || "[object Object]" !== ye.call(e)) && (!(t = fe(e)) || "function" == typeof (n = ve.call(t, "constructor") && t.constructor) && we.call(n) === xe)
                },
            ...
            var ke = function (e) {
                function t(e, t, n, r) {
                    ...
                    if (!r && ((t ? t.ownerDocument || t : M) !== I && O(t), t = t || I, D)) {
                        if (11 !== h && (c = ge.exec(e)))
                            if (o = c[1]) {
                                if (9 === h) {
                        ...
                        if (x.qsa && !$[e + " "] && (!j || !j.test(e))) {
                            if (1 !== h) d = t, p = e;
                                ...
                                for ((s = t.getAttribute("id")) ? s = s.replace(we, xe) : t.setAttribute("id", s = H), l = A(e), i = l.length; i--;) l[i] = "#" + s + " " + f(l[i]);
                            ...
                            for (; t = t[r];)
                                if (1 === t.nodeType || a)
                                    if (f = t[H] || (t[H] = {}), l = f[t.uniqueID] || (f[t.uniqueID] = {}), o && o === t.nodeName.toLowerCase()) t = t[r] || t;
                                        ...
                                        if ((u = l[i]) && u[0] === U && u[1] === s) return p[2] = u[2];
                ...
                function m(e, t, n, o, i, a) {
                    return o && !o[H] && (o = m(o)), i && !i[H] && (i = m(i, a)), r(function (r, a, s, c) {
                        var u, l, f, p = [],
                            ...
                            w = n ? i || (r ? e : m || o) ? [] : a : v;
                        if (n && n(v, w, s, c), o)
                            for (u = g(w, d), o(u, [], s, c), l = u.length; l--;)(f = u[l]) && (w[d[l]] = !(v[d[l]] = f));
                        if (r) {
                            if (i || e) {
                                if (i) {
                                    for (u = [], l = w.length; l--;)(f = w[l]) && u.push(v[l] = f);
                                    i(null, w = [], u, c)
                                }
                                for (l = w.length; l--;)(f = w[l]) && (u = i ? Q(r, f) : p[l]) > -1 && (r[u] = !(a[u] = f))
                            }
                        } else w = g(w === a ? w.splice(m, w.length) : w), i ? i(null, a, w, c) : K.apply(a, w)
                    })
                }
                    ...
                    var o = n.length > 0,
                        ...
                        a = function (r, a, s, c, u) {
                            var l, f, p, d = 0,
                                ...
                                _ = w.length;
                            for (u && (k = a === I || a || u); h !== _ && null != (l = w[h]); h++) {
                                if (i && l) {
                ...
                var w, x, b, _, T, A, E, S, k, C, P, O, I, N, D, j, L, R, q, H = "sizzle" + 1 * new Date,
                    M = e.document,
                    U = 0,
                    W = 0,
                    F = n(),
                ...
                try {
                    K.apply(V = J.call(M.childNodes), M.childNodes), V[M.childNodes.length].nodeType
                } catch (e) {
                    K = {
                ...
                x = t.support = {}, T = t.isXML = function (e) {
                    ...
                    return r !== I && 9 === r.nodeType && r.documentElement ? (I = r, N = I.documentElement, D = !T(I), M !== I && (n = I.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", be, !1) : n.attachEvent && n.attachEvent("onunload", be)), x.attributes = o(function (e) {
                        return e.className = "i", !e.getAttribute("className")
                    }), x.getElementsByTagName = o(function (e) {
                        return e.appendChild(I.createComment("")), !e.getElementsByTagName("*").length
                    }), x.getElementsByClassName = he.test(I.getElementsByClassName), x.getById = o(function (e) {
                    ...
                    }, L = [], j = [], (x.qsa = he.test(I.querySelectorAll)) && (o(function (e) {
                    ...
                    })), (x.matchesSelector = he.test(R = N.matches || N.webkitMatchesSelector || N.mozMatchesSelector || N.oMatchesSelector || N.msMatchesSelector)) && o(function (e) {
                        x.disconnectedMatch = R.call(e, "*"), R.call(e, "[s!='']:x"), L.push("!=", re)
                        ...
                        return n || (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !x.sortDetached && t.compareDocumentPosition(e) === n ? e === I || e.ownerDocument === M && q(M, e) ? -1 : t === I || t.ownerDocument === M && q(M, t) ? 1 : C ? Q(C, e) - Q(C, t) : 0 : 4 & n ? -1 : 1)
                    } : function (e, t) {
                        if (e === t) return P = !0, 0;
                        var n, r = 0,
                            o = e.parentNode,
                    ...
                    if ((e.ownerDocument || e) !== I && O(e), n = n.replace(ce, "='$1']"), x.matchesSelector && D && !$[n + " "] && (!L || !L.test(n)) && (!j || !j.test(n))) try {
                        var r = R.call(e, n);
                    ...
                    var n = b.attrHandle[t.toLowerCase()],
                        r = n && z.call(b.attrHandle, t.toLowerCase()) ? n(e, t, !D) : void 0;
                    ...
                    var t, n = [],
                        r = 0,
                        o = 0;
                    if (P = !x.detectDuplicates, C = !x.sortStable && e.slice(0), e.sort(G), P) {
                            ...
                            return 1 === r && 0 === o ? function (e) {
                                ...
                                if (m) {
                                    ...
                                    if (h = [a ? m.firstChild : m.lastChild], a && v) {
                                        for (p = m, f = p[H] || (p[H] = {}), l = f[p.uniqueID] || (f[p.uniqueID] = {}), u = l[e] || [], d = u[0] === U && u[1], w = d && u[2], p = d && m.childNodes[d]; p = ++d && p && p[g] || (w = d = 0) || h.pop();)
                                            if (1 === p.nodeType && ++w && p === t) {
                                                l[e] = [U, d, w];
                                                break
                                            }
                                    } else if (v && (p = t, f = p[H] || (p[H] = {}), l = f[p.uniqueID] || (f[p.uniqueID] = {}), u = l[e] || [], d = u[0] === U && u[1], w = d), !1 === w)
                                        for (;
                                            (p = ++d && p && p[g] || (w = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== y : 1 !== p.nodeType) || !++w || (v && (f = p[H] || (p[H] = {}), l = f[p.uniqueID] || (f[p.uniqueID] = {}), l[e] = [U, w]), p !== t)););
                ...
                }, x.sortStable = H.split("").sort(G).join("") === H, x.detectDuplicates = !!P, O(), x.sortDetached = o(function (e) {
            ...
            Ee.extend({
                ...
                data: function (e, t) {
                    var n, r, o, i = this[0],
                        a = i && i.attributes;
                    if (void 0 === e) {
                        if (this.length && (o = $e.get(i), 1 === i.nodeType && !Be.get(i, "hasDataAttrs"))) {
                ...
                queue: function (e, t, n) {
                    var r;
                    if (e) return t = (t || "fx") + "queue", r = Be.get(e, t), n && (!r || Array.isArray(n) ? r = Be.access(e, t, Ee.makeArray(n)) : r.push(n)), r || []
                },
            ...
            Ee.event = {
                ...
                add: function (e, t, n, r, o) {
                    var i, a, s, c, u, l, f, p, d, h, g, m = Be.get(e);
                    if (m)
                ...
                remove: function (e, t, n, r, o) {
                    var i, a, s, c, u, l, f, p, d, h, g, m = Be.hasData(e) && Be.get(e);
                    if (m && (c = m.events)) {
                ...
                style: function (e, t, n, r) {
                    if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                        var o, i, a, s = v(t),
                            c = mt.test(t),
                            u = e.style;
                        if (c || (t = F(s)), a = Ee.cssHooks[t] || Ee.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (o = a.get(e, !1, r)) ? o : u[t];
                        i = typeof n, "string" === i && (o = Ye.exec(n)) && o[1] && (n = _(e, t, o), i = "number"), null != n && n === n && ("number" === i && (n += o && o[3] || (Ee.cssNumber[s] ? "" : "px")), be.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (c ? u.setProperty(t, n) : u[t] = n))
                    }
                },
                css: function (e, t, n, r) {
                    var o, i, a, s = v(t);
                    return mt.test(t) || (t = F(s)), a = Ee.cssHooks[t] || Ee.cssHooks[s], a && "get" in a && (o = a.get(e, !0, n)), void 0 === o && (o = M(e, t, r)), "normal" === o && t in vt && (o = vt[t]), "" === n || n ? (i = parseFloat(o), !0 === n || isFinite(i) ? i || 0 : o) : o
                }
                ...
                Ee.cssHooks[t] = {
                    ...
                    set: function (e, n, r) {
                        var o, i = dt(e),
                            ...
                            s = r && $(e, t, r, a, i);
                        return a && be.scrollboxSize() === i.position && (s -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(i[t]) - $(e, t, "border", !1, i) - .5)), s && (o = Ye.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = Ee.css(e, t)), B(e, n, s)
                    }
                }
            }), Ee.cssHooks.marginLeft = U(be.reliableMarginLeft, function (e, t) {
                if (t) return (parseFloat(M(e, "marginLeft")) || e.getBoundingClientRect().left - Je(e, {
                    marginLeft: 0
                }, function () {
            ...
            Ee.Animation = Ee.extend(Z, {
                    tweeners: {
                        "*": [function (e, t) {
                            ...
                            return _(n.elem, e, Ye.exec(t), n), n
                        }]
                    },
            ...
            Ee.extend(Ee.event, {
                trigger: function (e, t, r, o) {
                    ...
                    if (a = p = s = r = r || le, 3 !== r.nodeType && 8 !== r.nodeType && !Ot.test(h + Ee.event.triggered) && (h.indexOf(".") > -1 && (g = h.split("."), h = g.shift(), g.sort()), u = h.indexOf(":") < 0 && "on" + h, e = e[Ee.expando] ? e : new Ee.Event(h, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = g.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), t = null == t ? [e] : Ee.makeArray(t, [e]), f = Ee.event.special[h] || {}, o || !f.trigger || !1 !== f.trigger.apply(r, t))) {
                        ...
                        for (i = 0;
                            (a = d[i++]) && !e.isPropagationStopped();) p = a, e.type = i > 1 ? c : f.bindType || h, l = (Be.get(a, "events") || {})[e.type] && Be.get(a, "handle"), l && l.apply(a, t), (l = u && a[u]) && l.apply && Fe(a) && (e.result = l.apply(a, t), !1 === e.result && e.preventDefault());
                        return e.type = h, o || e.isDefaultPrevented() || f._default && !1 !== f._default.apply(d.pop(), t) || !Fe(r) || u && _e(r[h]) && !Te(r) && (s = r[u], s && (r[u] = null), Ee.event.triggered = h, e.isPropagationStopped() && p.addEventListener(h, It), r[h](), e.isPropagationStopped() && p.removeEventListener(h, It), Ee.event.triggered = void 0, s && (r[u] = s)), e.result
                    }
                },
            ...
            Xt.href = Nt.href, Ee.extend({
                ...
                ajax: function (e, t) {
                    function r(e, t, r, s) {
                        var u, p, d, x, b, _ = t;
                        l || (l = !0, c && n.clearTimeout(c), o = void 0, a = s || "", T.readyState = e > 0 ? 4 : 0, u = e >= 200 && e < 300 || 304 === e, r && (x = se(h, T, r)), x = ce(h, x, T, u), u ? (h.ifModified && (b = T.getResponseHeader("Last-Modified"), b && (Ee.lastModified[i] = b), (b = T.getResponseHeader("etag")) && (Ee.etag[i] = b)), 204 === e || "HEAD" === h.type ? _ = "nocontent" : 304 === e ? _ = "notmodified" : (_ = x.state, p = x.data, d = x.error, u = !d)) : (d = _, !e && _ || (_ = "error", e < 0 && (e = 0))), T.status = e, T.statusText = (t || _) + "", u ? y.resolveWith(g, [p, _, T]) : y.rejectWith(g, [T, _, d]), T.statusCode(w), w = void 0, f && m.trigger(u ? "ajaxSuccess" : "ajaxError", [T, h, u ? p : d]), v.fireWith(g, [T, _]), f && (m.trigger("ajaxComplete", [T, h]), --Ee.active || Ee.event.trigger("ajaxStop")))
                    }
                    ...
                    if (h.data && h.processData && "string" != typeof h.data && (h.data = Ee.param(h.data, h.traditional)), ie(zt, h, t, T), l) return T;
                    f = Ee.event && h.global, f && 0 == Ee.active++ && Ee.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !$t.test(h.type), i = h.url.replace(Ut, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Mt, "+")) : (d = h.url.slice(i.length), h.data && (h.processData || "string" == typeof h.data) && (i += (jt.test(i) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (i = i.replace(Wt, "$1"), d = (jt.test(i) ? "&" : "?") + "_=" + Dt++ + d), h.url = i + d), h.ifModified && (Ee.lastModified[i] && T.setRequestHeader("If-Modified-Since", Ee.lastModified[i]), Ee.etag[i] && T.setRequestHeader("If-None-Match", Ee.etag[i])), (h.data && h.hasContent && !1 !== h.contentType || t.contentType) && T.setRequestHeader("Content-Type", h.contentType), T.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Yt + "; q=0.01" : "") : h.accepts["*"]);
                    for (p in h.headers) T.setRequestHeader(p, h.headers[p]);
                    if (h.beforeSend && (!1 === h.beforeSend.call(g, T, h) || l)) return T.abort();
                    if (_ = "abort", v.add(h.complete), T.done(h.success), T.fail(h.error), o = ie(Vt, h, t, T)) {
            ...
            Ee.ajaxSetup({
                ...
                Ee.cssHooks[t] = U(be.pixelPosition, function (e, n) {
                    if (n) return n = M(e, t), pt.test(n) ? Ee(e).position()[t] + "px" : n
                })
            }), Ee.each({
                Height: "height",
                Width: "width"
    ...
    5: function (e, t) {
        var n = function () {
            function e(e) {
                return null == e ? String(e) : V[Y.call(e)] || "object"
            }
            ...
            return X.matches = function (e, t) {
                ...
                var r, o = e.parentNode,
                    i = !o;
                return i && (o = K).appendChild(e), r = ~X.qsa(o, t).indexOf(e), i && K.removeChild(e), r
            }, S = function (e) {
                ...
                if (!e) return X.Z();
                if ("string" == typeof e)
                    if (e = e.trim(), "<" == e[0] && R.test(e)) r = X.fragment(e, RegExp.$1, n), e = null;
                    else {
                    ...
                    else if (R.test(e)) r = X.fragment(e.trim(), RegExp.$1, n), e = null;
                    else {
                        if (n !== _) return A(n).find(e);
                        r = X.qsa(N, e)
                    }
                ...
                concat: function () {
                    ...
                    return P.apply(X.isZ(this) ? this.toArray() : this, n)
                },
                map: function (e) {
                ...
                find: function (e) {
                    ...
                    }) : 1 == this.length ? A(X.qsa(this[0], e)) : this.map(function () {
                        return X.qsa(this, e)
                    }) : A()
                },
                closest: function (e, t) {
                    ...
                    return this.each(function (i, a) {
                        for (; a && !(o ? o.indexOf(a) >= 0 : X.matches(a, e));) a = a !== t && !r(a) && a.parentNode;
                ...
                removeClass: function (e) {
                    return this.each(function (t) {
                        if ("className" in this) {
                            ...
                            E = w(this), y(this, e, t, E).split(/\s+/g).forEach(function (e) {
                                E = E.replace(l(e), " ")
                            }), w(this, E.trim())
                        }
                    })
                ...
                offsetParent: function () {
                    return this.map(function () {
                        for (var e = this.offsetParent || N.body; e && !M.test(e.nodeName) && "static" == A(e).css("position");) e = e.offsetParent;
                        return e
                    })
                }
                ...
                A.fn[t] = function () {
                    var t, o, i = A.map(arguments, function (n) {
                            ...
                            return t = e(n), "array" == t ? (n.forEach(function (e) {
                                return e.nodeType !== _ ? r.push(e) : A.zepto.isZ(e) ? r = r.concat(e.get()) : void(r = r.concat(X.fragment(e)))
                            }), r) : "object" == t || null == n ? n : X.fragment(n)
                        }),
                        a = this.length > 1;
            ...
            }), X.Z.prototype = h.prototype = A.fn, X.uniq = k, X.deserializeValue = x, A.zepto = X, A
        }();
